...
//Java syntax
        //This is a comment
        System.out.println("my first homework assignment");

        /* The code above will print out Hello, world
        oh and this is a multiline comment
         */


//Java Varibles/Containers

        /*  to declare a variable you must specify the datatype and assign
        it a value.
        ...
        myNum = 12; // mynum2 value has been changed
        System.out.println(myNum2);

        final int myNum3 = 11; // final variables can not be changed

        // other data types that can be declared
        int myNum4 = 5;
        ...
        String name = "Jordan";
        System.out.println("Hello" + name); /*you can use the + operator to add strings
        to make longer strings */

        String firstName = "John ";
        String lastName = "Doe";
        String fullName = firstName + lastName;
        System.out.println(fullName); // you can add variables together
